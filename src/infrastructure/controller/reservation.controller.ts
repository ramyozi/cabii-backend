...
export class ReservationController {
  ...
  @ApiOperation({ summary: 'List reservations by customer' })
  @ApiResponse({ type: ReservationListResponseDto, status: HttpStatus.OK })
  ...
  async getListByCustomer(
    ...
    const reservations =
      await this.reservationAppService.getListByCustomer(customerId);
  ...
  @ApiOperation({ summary: 'List reservations by driver' })
  @ApiResponse({ type: ReservationListResponseDto, status: HttpStatus.OK })
  @Get('driver/:driverId')
  async getListByDriver(
    @Param('driverId', new ParseUUIDPipe()) driverId: string,
  ) {
    const reservations =
      await this.reservationAppService.getListByDriver(driverId);
